import { BadRequestError } from '../../dist'
import { MethodArgumentNotValidError, StringUtils } from '../base'
...
export class PersonName {
  ...
  constructor(value: string, min: number = 3, max: number = 80) {
    ...
    // if (names.length < 2) {
    //   throw new MethodArgumentNotValidError('person-name.surname-missing')
    // }
  }
